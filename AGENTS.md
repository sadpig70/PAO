...
- PowerShell 7 at `D:\Tools\PS7\7.6.3\pwsh.exe` (UTF-8). Old PowerShell 5.1 forbidden.
...
- When using PowerShell 7, always invoke `D:\Tools\PS7\7.6.3\pwsh.exe -NoProfile` explicitly; never rely on the default `powershell` shell.
